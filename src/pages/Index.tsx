    ...
    <div className="min-h-screen">
      <div className="container py-8 space-y-6">
        <div className="text-center mb-8">
          ...
          <p className="text-cheese/70 mt-1">View and organize your gpk.topps cards. Open packs and drag and reorder cards where you want them.<br />Supports SimpleAssets and AtomicAssets.</p>
        </div>
