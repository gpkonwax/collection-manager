          ...
          <div className="text-center mb-8">
            ...
            {(categoryFilter === 'series1' || categoryFilter === 'series2' || categoryFilter === 'exotic') && (
              <p className="mt-3 inline-flex flex-wrap items-center justify-center gap-2 text-sm text-cheese/80 theme-bright-text-muted">
                ...
                <span>to</span>
                <img src={logoAtomicAssets} alt="AtomicAssets" title="AtomicAssets" className="h-10 w-auto rounded-full" />
                <a
        ...
        <div className="container">
          <div className="grid grid-cols-1 sm:grid-cols-3 items-center gap-4">
            ...
            <div className="text-xs text-cheese space-y-0.5 text-center sm:text-right">
              ...
              <p>• <button type="button" onClick={() => footerRequestNav('https://atomichub.io/bridge')} className="hover:underline">Bridge</button></p>
            ...
            <div className="flex flex-col sm:flex-row sm:items-start gap-2 sm:gap-4">
              {isConnected && accountName && (
                <button
                  type="button"
                  onClick={() => setShowDonateDialog(true)}
                  className="shrink-0 text-xs font-semibold text-cheese hover:underline text-left"
                >
                  Donate
                </button>
              )}
